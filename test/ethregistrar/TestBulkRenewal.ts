...
async function fixture() {
  ...
  // Configure a resolver for .beam and register the controller interface
  // then transfer the .beam node to the base registrar.
  ...
  await ensRegistry.write.setOwner([namehash('beam'), baseRegistrar.address])
